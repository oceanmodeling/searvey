...
from searvey.coops import (COOPS_Station, coops_product_within_region, coops_stations, coops_stations_within_region)
...
def test_coops_product_within_region():
    ...
    data = coops_product_within_region(
        'water_level', region=region, start_date=start_date, end_date=end_date,
    )
